...
<button id="backbtn" ><a href="<%=request.getContextPath() %>/sharePage/sharemain.jsp" >나눔목록으로 돌아가기</a></button>

    <img src="<%=request.getContextPath() %>/images/캐릭터2.gif">
    <button onClick="javascript:goDetail('테스트');">사용방법이 궁금하면 클릭하세요 !</button>
